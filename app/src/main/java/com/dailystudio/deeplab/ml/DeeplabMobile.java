...
public class DeeplabMobile implements DeeplabInterface {
    ...
    private final static String MODEL_FILE = "frozen_inference_graph_mscoco.pb";
//    private final static String MODEL_FILE = "frozen_inference_graph_cityscapes.pb";
    ...
    public boolean initialize(Context context) {
        ...
        AssetManager.AssetInputStream  graphStream;
        try {
            AssetManager assetManager = context.getAssets();
            graphStream=(AssetManager.AssetInputStream) assetManager.open("frozen_inference_graph_mscoco.pb");
        } catch (IOException e) {
